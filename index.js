    ...
    <div class="hero-visual">
      <div class="emo-card">
        <div class="emo-card-header">
          ...
          <span class="emo-pill emo-tag-soft">Demo mode</span>
        </div>
        ...
        <div class="emo-hero-visual-row">
          ...
          <div class="drift-core">
            <div class="drift-spiral-shell">
              ...
              <div class="drift-layer"></div>
              <div class="drift-layer"></div>
              <div class="drift-spiral calm strong"></div>
              <div class="drift-spiral-orbit">
                <div class="drift-spiral-dot"></div>
              </div>
            </div>

            <div>
              <div class="drift-label">Emotional drift</div>
              <div class="drift-value positive">+12%</div>
              <div class="drift-caption">Calmness increasing</div>
            </div>
          </div>
        ...
        <div class="scenario-buttons">
          <button class="scenario-button">Smile</button>
          <button class="scenario-button">Neutral</button>
          <button class="scenario-button">Stress</button>
          <button class="scenario-button">High stress</button>
          <button class="scenario-button">Calm mode</button>
          <button class="scenario-button">Focus mode</button>
        </div>
      ...
      <div class="hero-metrics-row">
        ...
        <div class="emotional-weather-card">
          ...
          <div class="emo-flex emo-flex-between">
            ...
            <div class="emotional-weather-icon calm"></div>
          </div>
        </div>
